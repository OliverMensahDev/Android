package wapmass.myfirstapp.QuoteServer;

import java.util.concurrent.ThreadLocalRandom;

public class Server {
 private String[] quotes = new String[]{"I remember, when 9/11 went down, my reaction was, \"\"Well, I've had it with humanity.\"\"",
 ...
 public String getSingleQuote(int id){
     return quotes[id];
 }
