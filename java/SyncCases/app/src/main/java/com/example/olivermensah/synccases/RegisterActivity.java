...
public class RegisterActivity extends AppCompatActivity {
    ...
    //widgets
    private EditText mEmail, mPassword, mConfirmPassword, mName,  mAge, mPhone, mOrganization;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mOrganization = (EditText) findViewById(R.id.input_organization);
        ...
        mRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!isEmpty(mEmail.getText().toString())
                        ...
                        && !isEmpty(mOrganization.getText().toString())
                        ){
                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (task.isSuccessful()){
                            ...
                            User user = new User();
                            user.setEmail(mPhone.getText().toString());
                            user.setName(mName.getText().toString());
                            user.setAge(mName.getText().toString());
                            user.setOrganization(mOrganization.getText().toString());
